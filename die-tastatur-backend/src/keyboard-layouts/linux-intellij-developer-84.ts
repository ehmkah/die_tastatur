...
export function linuxIntellijDeveloperLayoutFor84(keyboardService: KeyboardsService, keyboardLayoutsService: KeyboardLayoutsService): KeyboardLayout {

    let keysetTerminal = KeysetDefinitions.TERMINAL_MACOSX;
    let keysetLinuxClassic = KeysetDefinitions.INTELLIJ_CLASSIC_LINUX;
    const keyboard = keyboardService.findById(KeyboardIds.PREHKEYTECH_84);
...
//    board[1][11] = keyboardLayoutsService.createKeyDetails('1_11', CommandsDefinitions.IDE_EDITING_SHOW_DESCRIPTION_ERROR_OR_WARNING_AT_CARRET, keysetLinuxClassic);
    ...
    return <KeyboardLayout>{
        ...
        keyboard,
        name: 'Linux Intellij Developer Keyboard for 84 keyboard',

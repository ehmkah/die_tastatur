...
describe('KeyboardLayoutsService', () => {
  ...
  it('should generate test keyboard for one executionset', () => {
    ...
    expect(actual[0].keys[7][15].execution.command.name).toEqual('IDE_VCS_UPDATE_TO_VCS');
    ...
    expect(actual[1].keys[0][0].execution.command.name).toEqual('IDE_VCS_PUSH_TO_VCS');

...
export function linuxIntellijDeveloperLayout(keyboard: Keyboard, keyboardLayoutsService: KeyboardLayoutsService): KeyboardLayout {
    ...
    board[1][1] = keyboardLayoutsService.createKeyDetails('1_3', CommandsDefinitions.IDE_NAVIGATION_GOTO_CLASS, keysetLinuxClassic);
    board[1][2] = keyboardLayoutsService.createKeyDetails('1_3', CommandsDefinitions.IDE_NAVIGATION_GOTO_FILE, keysetLinuxClassic);
    ...
    board[1][5] = keyboardLayoutsService.createKeyDetails('1_5', CommandsDefinitions.IDE_NAVIGATION_GO_TO_LINE, keysetLinuxClassic);
    board[1][6] = keyboardLayoutsService.createKeyDetails('1_6', CommandsDefinitions.IDE_NAVIGATION_GOTO_PREVIOUS_METHOD, keysetLinuxClassic);
    board[1][7] = keyboardLayoutsService.createKeyDetails('1_7', CommandsDefinitions.IDE_NAVIGATION_GOTO_NEXT_METHOD, keysetLinuxClassic);
    board[1][8] = keyboardLayoutsService.createKeyDetails('1_8', CommandsDefinitions.IDE_NAVIGATION_NEXT_HIGHLIGHTED_ERROR, keysetLinuxClassic);
    board[1][9] = keyboardLayoutsService.createKeyDetails('1_9', CommandsDefinitions.IDE_NAVIGATION_PREVIOUS_HIGHLIGHTED_ERROR, keysetLinuxClassic);
    board[1][10] = keyboardLayoutsService.createKeyDetails('1_10', CommandsDefinitions.IDE_EDITING_SHOW_DESCRIPTION_ERROR_OR_WARNING_AT_CARRET, keysetLinuxClassic);

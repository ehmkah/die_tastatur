...
export function linuxIntellijDeveloperLayout(keyboard: Keyboard, keyboardLayoutsService: KeyboardLayoutsService): KeyboardLayout {
    ...
    let keysetWebstorm = KeysetDefinitions.INTELLIJ_CLASSIC_LINUX;
    ...
    board[4][1] = keyboardLayoutsService.createKeyDetails('4_1', CommandsDefinitions.IDE_VCS_COMMIT_TO_VCS, keysetWebstorm);
    //board[4][2] = keyboardLayoutsService.createKeyDetails('4_3', CommandsDefinitions.COMMIT, keysetWebstorm);
    board[4][3] = keyboardLayoutsService.createKeyDetails('4_3', CommandsDefinitions.IDE_VCS_PUSH_TO_VCS, keysetWebstorm);
    board[4][4] = keyboardLayoutsService.createKeyDetails('4_4', CommandsDefinitions.IDE_VCS_UPDATE_TO_VCS, keysetWebstorm);

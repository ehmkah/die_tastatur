...
export function webstormDefaultMaxosxExecutions(executionService: ExecutionsService, keyset: Keyset): Array<Execution> {
    ...
    return [
        ...
        executionService.createExecution('IDE_EDITING_COLLAPSE_CODE_BLOCK', CommandsDefinitions.IDE_EDITING_COLLAPSE_CODE_BLOCK, keyset, `{${SpecialKeys.LWIN}+${SpecialKeys.MINUS}}`),
        executionService.createExecution('IDE_EDITING_EXPAND_ALL', CommandsDefinitions.IDE_EDITING_EXPAND_ALL, keyset, `{${SpecialKeys.LWIN}+${SpecialKeys.PLUS}}`),

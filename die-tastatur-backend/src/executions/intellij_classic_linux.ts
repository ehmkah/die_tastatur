...
export function intellijClassicLinuxExecutions(executionService: ExecutionsService, keysetService: KeysetsService): Array<Execution> {
    ...
    const executions = [
        ...
        new InternalExecution(CommandsDefinitions.IDE_GENERAL_COLUMN_SELECTION_MODE, `{${SpecialKeys.SHIFT}+{${SpecialKeys.ALT}+${SpecialKeys.INS}}}`),
        ...
        new InternalExecution(CommandsDefinitions.IDE_NAVIGATION_GOTO_NEXT_METHOD, `{${SpecialKeys.ALT}+${SpecialKeys.CURSOR_DOWN}}`),
        new InternalExecution(CommandsDefinitions.IDE_NAVIGATION_GOTO_PREVIOUS_METHOD, `{${SpecialKeys.ALT}+${SpecialKeys.CURSOR_UP}}`),

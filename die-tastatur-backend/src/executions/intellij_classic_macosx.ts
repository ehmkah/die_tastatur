...
export function intellijClassicMaxosxExecutions(executionService: ExecutionsService, keyset: Keyset): Array<Execution> {
    ...
    return [
        ...
        executionService.createExecution('IDE_EDITING_DELETE_WORD_END', CommandsDefinitions.IDE_EDITING_DELETE_WORD_END, keyset, `{${SpecialKeys.ALT}${SpecialKeys.BACKSPACE}}`),

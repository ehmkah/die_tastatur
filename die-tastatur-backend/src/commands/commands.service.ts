...
export class CommandsService {
    ...
    findAll(): Array<Command> {
        return [
            ...
            <Command>{id: 'ide_navigation_goto_type_definitiaon', description: 'Goto type declaration', defaultKeyPrintText: 'type definition', name: CommandsDefinitions.IDE_NAVIGATION_GOTO_TYPE_DEFINITIAON},

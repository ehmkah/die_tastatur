...
export class CommandsService {
    ...
    findAll(): Array<Command> {
        return [
            ...
            <Command>{id: 'IDE_RUNNINGRUN_RUN_ANYTHING', description: 'Running anything', defaultKeyPrintText: 'Run anything', name: CommandsDefinitions.IDE_RUNNINGRUN_RUN_ANYTHING},
            ...
            <Command>{id: 'ide_vcs_update_to_vcs', description: 'Update from VCS ', defaultKeyPrintText: 'VCS update', name: CommandsDefinitions.IDE_VCS_UPDATE_TO_VCS},
            <Command>{id: 'IDE_VCS_PUSH_TO_VCS', description: 'Push to VCS ', defaultKeyPrintText: 'VCS push', name: CommandsDefinitions.IDE_VCS_PUSH_TO_VCS},
